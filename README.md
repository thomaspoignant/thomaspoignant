...
- [open-feature/dotnet-sdk](https://github.com/open-feature/dotnet-sdk) ([v2.3.0](https://github.com/open-feature/dotnet-sdk/releases/tag/v2.3.0), 2 days ago) - .NET implementation of the OpenFeature SDK
- [open-feature/swift-sdk](https://github.com/open-feature/swift-sdk) ([0.3.0](https://github.com/open-feature/swift-sdk/releases/tag/0.3.0), 2 days ago) - Swift implementation of the OpenFeature SDK for iOS clients
- [open-feature/ruby-sdk-contrib](https://github.com/open-feature/ruby-sdk-contrib) ([openfeature-go-feature-flag-provider/v0.1.3](https://github.com/open-feature/ruby-sdk-contrib/releases/tag/openfeature-go-feature-flag-provider/v0.1.3), 6 days ago) - Community contributions for hooks and reference providers in Ruby
...
- [open-feature/php-sdk-contrib](https://github.com/open-feature/php-sdk-contrib) - OpenFeature Providers and Hooks for PHP (4 days ago)
...
- [adevinta/observability-operator](https://github.com/adevinta/observability-operator) - A k8s operator to orchestrate telemetry gathering from workloads and forwarding it to their desired destination. (2 days ago)
- [ollama/ollama](https://github.com/ollama/ollama) - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models. (4 days ago)
