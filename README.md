...
- [open-feature/java-sdk](https://github.com/open-feature/java-sdk) ([dev.openfeature.javasdk-v0.2.2](https://github.com/open-feature/java-sdk/releases/tag/dev.openfeature.javasdk-v0.2.2), 1 day ago) - Java implementation of the OpenFeature SDK
- [open-feature/flagd](https://github.com/open-feature/flagd) ([v0.1.1](https://github.com/open-feature/flagd/releases/tag/v0.1.1), 1 day ago) - A generic feature flag daemon
- [open-feature/js-sdk-contrib](https://github.com/open-feature/js-sdk-contrib) ([flagd-provider-v0.5.1](https://github.com/open-feature/js-sdk-contrib/releases/tag/flagd-provider-v0.5.1), 2 days ago) - OpenFeature Providers and Hooks for JavaScript
