...
- [thomaspoignant/go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ([v0.28.1](https://github.com/thomaspoignant/go-feature-flag/releases/tag/v0.28.1), 6 days ago) - A simple and complete feature flag solution, without any complex backend system to install, all you need is a file as your backend. 🎛️
- [open-feature/flagd](https://github.com/open-feature/flagd) ([v0.2.2](https://github.com/open-feature/flagd/releases/tag/v0.2.2), 1 week ago) - A generic feature flag daemon
- [open-feature/js-sdk-contrib](https://github.com/open-feature/js-sdk-contrib) ([flagd-provider-v0.6.0](https://github.com/open-feature/js-sdk-contrib/releases/tag/flagd-provider-v0.6.0), 1 week ago) - OpenFeature Providers and Hooks for JavaScript
...
- [ixtendio/gofre](https://github.com/ixtendio/gofre) - A simple GO web framework  (5 days ago)
