...
- [open-feature/dotnet-sdk-contrib](https://github.com/open-feature/dotnet-sdk-contrib) ([OpenFeature.Contrib.Hooks.Otel-v0.1.2](https://github.com/open-feature/dotnet-sdk-contrib/releases/tag/OpenFeature.Contrib.Hooks.Otel-v0.1.2), 1 day ago) - OpenFeature Providers and Hooks for .NET
- [open-feature/kotlin-sdk](https://github.com/open-feature/kotlin-sdk) ([v0.2.1](https://github.com/open-feature/kotlin-sdk/releases/tag/v0.2.1), 1 day ago) - Kotlin implementation of the OpenFeature SDK for Android clients
- [open-feature/java-sdk](https://github.com/open-feature/java-sdk) ([v1.7.2](https://github.com/open-feature/java-sdk/releases/tag/v1.7.2), 6 days ago) - Java implementation of the OpenFeature SDK
