...
- [open-feature/java-sdk-contrib](https://github.com/open-feature/java-sdk-contrib) ([dev.openfeature.contrib.hooks.otel-v2.0.0](https://github.com/open-feature/java-sdk-contrib/releases/tag/dev.openfeature.contrib.hooks.otel-v2.0.0), 1 day ago) - Community contributions for hooks and reference providers
- [open-feature/flagd](https://github.com/open-feature/flagd) ([core/v0.6.0](https://github.com/open-feature/flagd/releases/tag/core/v0.6.0), 1 day ago) - A feature flag daemon with a Unix philosophy
- [open-feature/java-sdk](https://github.com/open-feature/java-sdk) ([v1.4.0](https://github.com/open-feature/java-sdk/releases/tag/v1.4.0), 2 days ago) - Java implementation of the OpenFeature SDK
