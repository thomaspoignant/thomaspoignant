...
- [open-feature/go-sdk-contrib](https://github.com/open-feature/go-sdk-contrib) ([providers/from-env/v0.1.5](https://github.com/open-feature/go-sdk-contrib/releases/tag/providers/from-env/v0.1.5), today) - Community maintained OpenFeature Providers and Hooks for Go
- [thomaspoignant/go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ([v1.30.0](https://github.com/thomaspoignant/go-feature-flag/releases/tag/v1.30.0), 2 days ago) - GO Feature Flag is a simple, complete and lightweight self-hosted feature flag solution 100% Open Source. 🎛️
- [open-feature/dotnet-sdk-contrib](https://github.com/open-feature/dotnet-sdk-contrib) ([OpenFeature.Contrib.Providers.Statsig-v0.0.6](https://github.com/open-feature/dotnet-sdk-contrib/releases/tag/OpenFeature.Contrib.Providers.Statsig-v0.0.6), 5 days ago) - OpenFeature Providers and Hooks for .NET
