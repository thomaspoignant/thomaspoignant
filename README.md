...
- [thomaspoignant/go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ([v0.27.2](https://github.com/thomaspoignant/go-feature-flag/releases/tag/v0.27.2), 3 days ago) - A simple and complete feature flag solution, without any complex backend system to install, all you need is a file as your backend. 🎛️
- [open-feature/java-sdk](https://github.com/open-feature/java-sdk) ([0.1.0](https://github.com/open-feature/java-sdk/releases/tag/0.1.0), 4 days ago) - Java implementation of the OpenFeature SDK
