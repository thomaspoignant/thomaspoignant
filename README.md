...
- [open-feature/go-sdk-contrib](https://github.com/open-feature/go-sdk-contrib) ([tests/flagd/v1.5.0](https://github.com/open-feature/go-sdk-contrib/releases/tag/tests/flagd/v1.5.0), 2 days ago) - Community maintained OpenFeature Providers and Hooks for Go
- [open-feature/java-sdk-contrib](https://github.com/open-feature/java-sdk-contrib) ([dev.openfeature.contrib.providers.flagd-v0.11.15](https://github.com/open-feature/java-sdk-contrib/releases/tag/dev.openfeature.contrib.providers.flagd-v0.11.15), 2 days ago) - Community contributions for hooks and reference providers
- [open-feature/dart-server-sdk](https://github.com/open-feature/dart-server-sdk) ([v0.0.12](https://github.com/open-feature/dart-server-sdk/releases/tag/v0.0.12), 4 days ago) - Experimential ServerSide Dark SDK For OpenFeature
...
- [idosal/git-mcp](https://github.com/idosal/git-mcp) - Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project (6 days ago)
- [abistama/support-hero](https://github.com/abistama/support-hero) -  (1 week ago)
