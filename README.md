...
- [open-feature/js-sdk-contrib](https://github.com/open-feature/js-sdk-contrib) ([flagd-web-provider-v0.3.0](https://github.com/open-feature/js-sdk-contrib/releases/tag/flagd-web-provider-v0.3.0), today) - OpenFeature Providers and Hooks for JavaScript
- [open-feature/js-sdk](https://github.com/open-feature/js-sdk) ([web-sdk-v0.2.0-experimental](https://github.com/open-feature/js-sdk/releases/tag/web-sdk-v0.2.0-experimental), today) - JavaScript SDK for OpenFeature
