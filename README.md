...
- [open-feature/js-sdk-contrib](https://github.com/open-feature/js-sdk-contrib) ([config-cat-core-v0.1.1](https://github.com/open-feature/js-sdk-contrib/releases/tag/config-cat-core-v0.1.1), today) - OpenFeature Providers and Hooks for JavaScript
- [go-feature-flag/openfeature-swift-provider](https://github.com/go-feature-flag/openfeature-swift-provider) ([v0.4.0](https://github.com/go-feature-flag/openfeature-swift-provider/releases/tag/v0.4.0), today) - Use GO Feature Flag with OpenFeature in your iOS / macOS / tvOS apps. 📱💻
