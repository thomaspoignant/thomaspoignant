...
- [thomaspoignant/go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ([v1.40.0](https://github.com/thomaspoignant/go-feature-flag/releases/tag/v1.40.0), 6 days ago) - GO Feature Flag is a simple, complete and lightweight self-hosted feature flag solution 100% Open Source. 🎛️
- [open-feature/swift-sdk](https://github.com/open-feature/swift-sdk) ([0.2.1](https://github.com/open-feature/swift-sdk/releases/tag/0.2.1), 6 days ago) - Swift implementation of the OpenFeature SDK for iOS clients
...
- [ahuangg/json-rules](https://github.com/ahuangg/json-rules) - json parser for golang rules engine (2 days ago)
