...
- [thomaspoignant/go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ([v1.38.0](https://github.com/thomaspoignant/go-feature-flag/releases/tag/v1.38.0), 1 day ago) - GO Feature Flag is a simple, complete and lightweight self-hosted feature flag solution 100% Open Source. 🎛️
- [open-feature/go-sdk-contrib](https://github.com/open-feature/go-sdk-contrib) ([providers/flipt/v0.1.3](https://github.com/open-feature/go-sdk-contrib/releases/tag/providers/flipt/v0.1.3), 2 days ago) - Community maintained OpenFeature Providers and Hooks for Go
- [open-feature/java-sdk-contrib](https://github.com/open-feature/java-sdk-contrib) ([dev.openfeature.contrib.providers.flagd-v0.10.0](https://github.com/open-feature/java-sdk-contrib/releases/tag/dev.openfeature.contrib.providers.flagd-v0.10.0), 1 week ago) - Community contributions for hooks and reference providers
...
- [go-feature-flag/app-api](https://github.com/go-feature-flag/app-api) - API to manage your feature flags. (3 days ago)
...
- [atc0005/go-teams-notify](https://github.com/atc0005/go-teams-notify) - A package to send messages to a Microsoft Teams channel (1 day ago)
...
- [giulbia](https://github.com/giulbia) (3 days ago)
- [efugier](https://github.com/efugier) (4 days ago)
