...
- [open-feature/dotnet-sdk](https://github.com/open-feature/dotnet-sdk) ([v2.3.0](https://github.com/open-feature/dotnet-sdk/releases/tag/v2.3.0), 4 days ago) - .NET implementation of the OpenFeature SDK
- [open-feature/swift-sdk](https://github.com/open-feature/swift-sdk) ([0.3.0](https://github.com/open-feature/swift-sdk/releases/tag/0.3.0), 4 days ago) - Swift implementation of the OpenFeature SDK for iOS clients
...
- [adevinta/observability-operator](https://github.com/adevinta/observability-operator) - A k8s operator to orchestrate telemetry gathering from workloads and forwarding it to their desired destination. (4 days ago)
- [ollama/ollama](https://github.com/ollama/ollama) - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models. (6 days ago)
