...
- [open-feature/java-sdk-contrib](https://github.com/open-feature/java-sdk-contrib) ([dev.openfeature.contrib.hooks.otel-v3.2.1](https://github.com/open-feature/java-sdk-contrib/releases/tag/dev.openfeature.contrib.hooks.otel-v3.2.1), today) - Community contributions for hooks and reference providers
- [open-feature/js-sdk-contrib](https://github.com/open-feature/js-sdk-contrib) ([unleash-web-provider-v0.1.1](https://github.com/open-feature/js-sdk-contrib/releases/tag/unleash-web-provider-v0.1.1), 3 days ago) - OpenFeature Providers and Hooks for JavaScript
...
- [ahuangg/json-rules](https://github.com/ahuangg/json-rules) - json parser for golang rules engine (3 weeks ago)
