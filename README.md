...
- [open-feature/dart-server-sdk](https://github.com/open-feature/dart-server-sdk) ([v0.0.11](https://github.com/open-feature/dart-server-sdk/releases/tag/v0.0.11), 5 days ago) - Experimential ServerSide Dark SDK For OpenFeature
- [open-feature/js-sdk-contrib](https://github.com/open-feature/js-sdk-contrib) ([ofrep-core-v1.1.0](https://github.com/open-feature/js-sdk-contrib/releases/tag/ofrep-core-v1.1.0), 6 days ago) - OpenFeature Providers and Hooks for JavaScript
...
- [idosal/git-mcp](https://github.com/idosal/git-mcp) - Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project (1 day ago)
- [abistama/support-hero](https://github.com/abistama/support-hero) -  (5 days ago)
