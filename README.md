...
- [open-feature/java-sdk](https://github.com/open-feature/java-sdk) ([v0.3.1](https://github.com/open-feature/java-sdk/releases/tag/v0.3.1), 2 days ago) - Java implementation of the OpenFeature SDK
- [thomaspoignant/go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ([v1.0.0-beta.3](https://github.com/thomaspoignant/go-feature-flag/releases/tag/v1.0.0-beta.3), 2 days ago) - A simple and complete feature flag solution, without any complex backend system to install, all you need is a file as your backend. 🎛️
- [open-feature/flagd](https://github.com/open-feature/flagd) ([v0.2.4](https://github.com/open-feature/flagd/releases/tag/v0.2.4), 2 days ago) - A generic feature flag daemon
