...
- [open-feature/java-sdk](https://github.com/open-feature/java-sdk) ([v1.0.0](https://github.com/open-feature/java-sdk/releases/tag/v1.0.0), 2 weeks ago) - Java implementation of the OpenFeature SDK
...
- [ixtendio/gofre](https://github.com/ixtendio/gofre) - A web framework for Go with middleware support and without third-party dependencies (1 month ago)
