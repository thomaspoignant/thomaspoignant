...
- [open-feature/js-sdk-contrib](https://github.com/open-feature/js-sdk-contrib) ([ofrep-web-provider-v0.4.3](https://github.com/open-feature/js-sdk-contrib/releases/tag/ofrep-web-provider-v0.4.3), 2 days ago) - OpenFeature Providers and Hooks for JavaScript
- [open-feature/java-sdk-contrib](https://github.com/open-feature/java-sdk-contrib) ([dev.openfeature.contrib.hooks.codereadiness-v0.1.1](https://github.com/open-feature/java-sdk-contrib/releases/tag/dev.openfeature.contrib.hooks.codereadiness-v0.1.1), 5 days ago) - Community contributions for hooks and reference providers
...
- [go-feature-flag/studio](https://github.com/go-feature-flag/studio) - A WIP repository to work on an UI (4 weeks ago)
...
- [fabriziodemaria/swift-sdk](https://github.com/fabriziodemaria/swift-sdk) - Swift implementation of the OpenFeature SDK for iOS clients (today)
- [TencentCloud/TencentDB-Agent-Memory](https://github.com/TencentCloud/TencentDB-Agent-Memory) - TencentDB Agent Memory is a team-level memory hub for AI Agents — turning conversations, docs, and code into four reusable memory assets (Chat Memory, Skill, LLM-Wiki, Code-Graph) that are governed, shared, and equipped across agents and frameworks. (6 days ago)
