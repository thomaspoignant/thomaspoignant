...
- [thomaspoignant/go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ([v1.13.0](https://github.com/thomaspoignant/go-feature-flag/releases/tag/v1.13.0), 1 day ago) - GO Feature Flag is a simple, complete and lightweight self-hosted feature flag solution 100% Open Source. 🎛️
- [open-feature/go-sdk](https://github.com/open-feature/go-sdk) ([v1.6.0](https://github.com/open-feature/go-sdk/releases/tag/v1.6.0), 1 day ago) - Go SDK for OpenFeature
- [thomaspoignant/scim-patch](https://github.com/thomaspoignant/scim-patch) ([v0.7.1](https://github.com/thomaspoignant/scim-patch/releases/tag/v0.7.1), 1 day ago) - Simple library to perform SCIM patch as describe in RFC 7644 https://tools.ietf.org/html/rfc7644#section-3.5.2
