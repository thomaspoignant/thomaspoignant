...
- [thomaspoignant/go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ([v1.41.0](https://github.com/thomaspoignant/go-feature-flag/releases/tag/v1.41.0), 1 day ago) - GO Feature Flag is a simple, complete and lightweight self-hosted feature flag solution 100% Open Source. 🎛️
- [open-feature/java-sdk-contrib](https://github.com/open-feature/java-sdk-contrib) ([dev.openfeature.contrib.hooks.otel-v3.2.1](https://github.com/open-feature/java-sdk-contrib/releases/tag/dev.openfeature.contrib.hooks.otel-v3.2.1), 2 days ago) - Community contributions for hooks and reference providers
- [open-feature/js-sdk-contrib](https://github.com/open-feature/js-sdk-contrib) ([unleash-web-provider-v0.1.1](https://github.com/open-feature/js-sdk-contrib/releases/tag/unleash-web-provider-v0.1.1), 5 days ago) - OpenFeature Providers and Hooks for JavaScript
