...
- [open-feature/go-sdk-contrib](https://github.com/open-feature/go-sdk-contrib) ([tests/flagd/v1.0.0](https://github.com/open-feature/go-sdk-contrib/releases/tag/tests/flagd/v1.0.0), today) - Community maintained OpenFeature Providers and Hooks for Go
- [open-feature/java-sdk](https://github.com/open-feature/java-sdk) ([v1.1.0](https://github.com/open-feature/java-sdk/releases/tag/v1.1.0), today) - Java implementation of the OpenFeature SDK
