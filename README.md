...
- [open-feature/go-sdk-contrib](https://github.com/open-feature/go-sdk-contrib) ([tests/flagd/v1.4.1](https://github.com/open-feature/go-sdk-contrib/releases/tag/tests/flagd/v1.4.1), 1 day ago) - Community maintained OpenFeature Providers and Hooks for Go
- [thomaspoignant/go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ([python-provider-v0.1.2](https://github.com/thomaspoignant/go-feature-flag/releases/tag/python-provider-v0.1.2), 2 days ago) - GO Feature Flag is a simple, complete and lightweight self-hosted feature flag solution 100% Open Source. 🎛️
- [open-feature/java-sdk](https://github.com/open-feature/java-sdk) ([v1.7.5](https://github.com/open-feature/java-sdk/releases/tag/v1.7.5), 6 days ago) - Java implementation of the OpenFeature SDK
