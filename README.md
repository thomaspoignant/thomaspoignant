...
- [open-feature/js-sdk-contrib](https://github.com/open-feature/js-sdk-contrib) ([config-cat-core-v0.2.1](https://github.com/open-feature/js-sdk-contrib/releases/tag/config-cat-core-v0.2.1), today) - OpenFeature Providers and Hooks for JavaScript
...
- [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) - The Web Data API for AI - Turn entire websites into LLM-ready markdown or structured data 🔥 (4 days ago)
