...
- [thomaspoignant/go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ([v1.5.0](https://github.com/thomaspoignant/go-feature-flag/releases/tag/v1.5.0), 2 days ago) - A simple and complete self hosted feature flag solution, without any complex backend system to install, all you need is a file as your backend. 🎛️
- [open-feature/go-sdk-contrib](https://github.com/open-feature/go-sdk-contrib) ([providers/flagsmith/v0.1.1](https://github.com/open-feature/go-sdk-contrib/releases/tag/providers/flagsmith/v0.1.1), 4 days ago) - Community maintained OpenFeature Providers and Hooks for Go
- [open-feature/java-sdk](https://github.com/open-feature/java-sdk) ([v1.3.0](https://github.com/open-feature/java-sdk/releases/tag/v1.3.0), 6 days ago) - Java implementation of the OpenFeature SDK
