...
- [open-feature/playground](https://github.com/open-feature/playground) ([v0.16.0](https://github.com/open-feature/playground/releases/tag/v0.16.0), 1 day ago) - OpenFeature SDK demos and experimentation
- [thomaspoignant/go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ([v1.28.1](https://github.com/thomaspoignant/go-feature-flag/releases/tag/v1.28.1), 2 days ago) - GO Feature Flag is a simple, complete and lightweight self-hosted feature flag solution 100% Open Source. 🎛️
- [open-feature/java-sdk-contrib](https://github.com/open-feature/java-sdk-contrib) ([dev.openfeature.contrib.providers.flagd-v0.8.1](https://github.com/open-feature/java-sdk-contrib/releases/tag/dev.openfeature.contrib.providers.flagd-v0.8.1), 6 days ago) - Community contributions for hooks and reference providers
