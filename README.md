...
- [open-feature/js-sdk-contrib](https://github.com/open-feature/js-sdk-contrib) ([ofrep-web-provider-v0.4.3](https://github.com/open-feature/js-sdk-contrib/releases/tag/ofrep-web-provider-v0.4.3), 3 days ago) - OpenFeature Providers and Hooks for JavaScript
- [open-feature/java-sdk-contrib](https://github.com/open-feature/java-sdk-contrib) ([dev.openfeature.contrib.hooks.codereadiness-v0.1.1](https://github.com/open-feature/java-sdk-contrib/releases/tag/dev.openfeature.contrib.hooks.codereadiness-v0.1.1), 6 days ago) - Community contributions for hooks and reference providers
...
- [fabriziodemaria/swift-sdk](https://github.com/fabriziodemaria/swift-sdk) - Swift implementation of the OpenFeature SDK for iOS clients (1 day ago)
