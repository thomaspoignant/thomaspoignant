...
- [thomaspoignant/go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) ([cmd/wasm/v0.1.2](https://github.com/thomaspoignant/go-feature-flag/releases/tag/cmd/wasm/v0.1.2), today) - GO Feature Flag is a simple, complete and lightweight self-hosted feature flag solution 100% Open Source. 🎛️
