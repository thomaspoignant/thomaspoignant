...
- [open-feature/flagd](https://github.com/open-feature/flagd) ([core/v0.4.4](https://github.com/open-feature/flagd/releases/tag/core/v0.4.4), 1 day ago) - A feature flag daemon with a Unix philosophy
- [open-feature/js-sdk](https://github.com/open-feature/js-sdk) ([shared-v0.0.2](https://github.com/open-feature/js-sdk/releases/tag/shared-v0.0.2), 2 days ago) - JavaScript SDK for OpenFeature
- [open-feature/js-sdk-contrib](https://github.com/open-feature/js-sdk-contrib) ([in-memory-provider-v0.1.1](https://github.com/open-feature/js-sdk-contrib/releases/tag/in-memory-provider-v0.1.1), 2 days ago) - OpenFeature Providers and Hooks for JavaScript
